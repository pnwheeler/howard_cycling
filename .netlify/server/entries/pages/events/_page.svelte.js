...
const css = {
  code: '.events-grid.svelte-n6dgkq.svelte-n6dgkq{display:grid;grid-template-areas:"tl tr"\r\n            "cl cr"\r\n            "b b";row-gap:1em;column-gap:2em;padding-inline:1em;margin-top:0.5em}.tl.svelte-n6dgkq.svelte-n6dgkq{grid-area:tl}.tr.svelte-n6dgkq.svelte-n6dgkq{grid-area:tr}.cl.svelte-n6dgkq.svelte-n6dgkq{grid-area:cl}.cr.svelte-n6dgkq.svelte-n6dgkq{grid-area:cr}.b.svelte-n6dgkq.svelte-n6dgkq{grid-area:b}.tr.svelte-n6dgkq.svelte-n6dgkq::after,.cr.svelte-n6dgkq.svelte-n6dgkq::after{content:"";height:2px;width:100%;background-color:var(--color-blue)}.tl.svelte-n6dgkq>h3.svelte-n6dgkq,.cl.svelte-n6dgkq>h3.svelte-n6dgkq{color:var(--color-blue)}.schedule-grid.svelte-n6dgkq.svelte-n6dgkq{display:grid;grid-template-columns:1fr 1fr;gap:1em}.more-info.svelte-n6dgkq.svelte-n6dgkq{grid-column:1 / 3}#note.svelte-n6dgkq.svelte-n6dgkq{justify-self:center}@media(max-width: 900px){.events-grid.svelte-n6dgkq.svelte-n6dgkq{padding-inline:0;grid-template-areas:"tl"\r\n                "cl"\r\n                "b"\r\n                "tr"\r\n                "cr"}#note.svelte-n6dgkq.svelte-n6dgkq{width:100%}}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<h2>Events</h2>
<div class="events-grid svelte-n6dgkq"><section class="div-block tl svelte-n6dgkq"><h3 class="center svelte-n6dgkq">2023 Howard Cycling Club Calendar</h3>
    ...
    <section class="div-block cl svelte-n6dgkq"><h3 class="center svelte-n6dgkq">Practice Schedule</h3>
        <div class="pane border-blue bg-dark"><div class="schedule-grid svelte-n6dgkq"><section><h3 class="text-center">Weekday</h3>
                ...
                <section class="more-info svelte-n6dgkq"><p class="center">If you are interested in further information please fill out the registration form.
                        There is no obligation after registration and the registration outlines specifics.
                    </p></section></div></div></section>

    <section class="div-block tr svelte-n6dgkq"><h3>MICL Events</h3>
    ...
    <section class="div-block cr svelte-n6dgkq"><h3>​GRiT</h3>
    ...
    <section class="div-block half pane border-light b svelte-n6dgkq" id="note"><h4 class="emphasize">Note:</h4>
