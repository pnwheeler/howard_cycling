...
const css = {
  code: ".registration-grid.svelte-ymg1a3{display:grid;grid-template-columns:repeat(2, 1fr);row-gap:1em;column-gap:2em;margin-top:0.5em;padding-inline:1em}select.svelte-ymg1a3{cursor:pointer;display:inline-flex;align-self:center;width:max-content;color:var(--color-light);background-color:var(--color-darker);height:1.5em;margin-left:0.5em;width:fit-content}option.svelte-ymg1a3{text-align:center}@media(max-width: 900px){.registration-grid.svelte-ymg1a3{padding-inline:0;row-gap:2em}}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex-row"><h2>Sign up as a </h2>
    <select class="border-blue svelte-ymg1a3">${each(options, (option) => {
    return `<option${add_attribute("value", option, 0)} class="svelte-ymg1a3">${escape(option.role)}</option>`;
  })}</select></div>

<div class="registration-grid svelte-ymg1a3">${validate_component(selected.component || missing_component, "svelte:component").$$render($$result, {}, {}, {})}</div>`;
});
export {
  Page as default
};
