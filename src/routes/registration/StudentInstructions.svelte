<div class="border-blue pane bg-dark">
    <ol>
        <li>Send an email to <a href="mailto:howardcyclingclub@gmail.com">howardcyclingclub@gmail.com</a> with the following information:</li>
        <ul>
            <li>Rider's Name</li>
            <li>Age</li>
            <li>Grade level (next school year)</li>
            <li>Parent contant information: name, phone #, & email</li>
        </ul>
        ...
        <li>Team dues will be collected through TeamApp after registration is completed.</li>
    </ol>
</div>
