...
<div class="activities-container">
    <section class="div-block">
        ...
        <p>
            Returning riders can register via the TeamApp link provided by email and can complete all
    ...
    <section class="div-block">
        ...
        <div class="pane border-blue bg-dark fit-content">
            <p>All riders are required to carry the following equipment to all practices and rides:</p>
            <ul class="indent">
        ...
        <p>
            All riders are responsible to ensure that they arrive ready to practice and ready to begin on
